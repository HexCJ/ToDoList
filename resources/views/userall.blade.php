...
<div class="mt-20">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold mt-2 mb-2 ms-3">Data User</h1>
            ...
            <tbody>
                ...
                <tr class="border">
                    ...
                    <td class="border px-4 py-2 text-center">
                        <a href="{{ route('users.show', $user->id) }}" class="text-blue-500 hover:text-blue-700"><i class="fa fa-eye" aria-hidden="true"></i>                        </a>

                        <button class="text-green-500 hover:text-green-700" onclick="confirmDelete('{{ $user->id }}')"> 
